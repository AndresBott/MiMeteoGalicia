...
//            f::p($data);
            ...
            <form class="form-horizontal" role="form" method="POST" action="<?=$navigation->getURL("User","addUser") ?>">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="user" class="form-control" id="user" placeholder="Username" value="<?=$data->getParam("user")?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4" for="rol">Role:</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-5" for="idEstacion">Meteorologic station:</label>
                    <div class="col-sm-7">
